...
Além disso, note que a matriz $\mathbf{J}$ (`Jnn`) pode ser obtida por $\mathbf{J} = \mathbf{j}\mathbf{j}'$, ou seja, a multiplicação do vetor coluna $\mathbf{j}$ pela sua transposta.
